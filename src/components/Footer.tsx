  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* Newsletter Section */}
        <div 
          className="border-t border-gray-800 pt-8 mb-8 animate-fade-in-delay-3"
        >
          <div className="max-w-md">
            <h3 className="text-lg font-semibold mb-3">Stay Updated</h3>
            <p className="text-gray-300 mb-4">Get the latest travel inspiration and exclusive offers.</p>
