...
async function main() {
  ...
  if (!csvFile) {
    ...
    console.log('Usage: node scripts/upload-experiences-admin.js <path-to-csv>');
    console.log('\nExample: node scripts/upload-experiences-admin.js ./experiences-enhanced.csv');
    process.exit(1);
  }
  ...
  try {
    ...
    console.log('📤 Starting admin upload (bypassing RLS)...');
